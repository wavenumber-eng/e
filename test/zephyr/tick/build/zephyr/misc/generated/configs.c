...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_VIDEO_SMARTDMA_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_NXP_VREF_ENABLED, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_OVTI_OV7670_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_CRICKETNODE_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DATA_BUF_POOL_BYTES, 10240);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_WAVENUMBER_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_MONKEY_BOOT_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG__E, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG__E_BQ_MAX_PRINTF_LEN, 256);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG__E_TICK_THREAD_STACK_SIZE, 4096);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_E_MODULE, 1);
